...
- **`l[list]_[subj_id].edf`**: The raw eye-tracking data for the entire eye-tracking session of each participant, in EDF format. (To be added).

- **`l[list]_[subj_id].asc`**: Gaze location and additional features at 1ms intervals for the entire eye-tracking session of each participant, in ASCII format. (To be added).
...
|                                   | is_correct       | Whether the participant selected the correct answer (A)                                                 | True / False                                 |
...
|                                   | subtlex_frequency            | -log$_2$ word frequency from the SUBTLEX-US database                                                                    | Bits                                                                                                |
|                                   | wordfreq_frequency           | -log$_2$ word frequency from the Wordfreq database                                                                      | Bits                                                                                                |
