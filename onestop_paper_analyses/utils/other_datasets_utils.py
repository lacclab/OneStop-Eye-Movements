...
def load_ia_fix_reports(dataset: str):
    ...
    if dataset == "onestop":
        ia_rep = pd.read_csv(
            "OneStop/ia_Paragraph.csv",
            engine="pyarrow",
        )
        fix_rep = pd.read_csv(
            "OneStop/fixations_Paragraph.csv",
            engine="pyarrow",
        )
        ...
        ia_rep = pd.read_csv(
            "other_datasets/sb-sat/18sat_fixfinal_ia_fixated_only.csv",
            engine="pyarrow",
        )
        fix_rep = pd.read_csv(
            "other_datasets/sb-sat/18sat_fixfinal.csv",
            engine="pyarrow",
        )
        ...
        ia_rep = pd.read_excel(
            "other_datasets/GECO/MonolingualReadingData.xlsx",
            engine="openpyxl",
        )
        fix_rep = None
        ...
        ia_rep = pd.read_csv(
            "other_datasets/celer/data_v2.0/sent_ia.tsv",
            sep="\t",
        )
        fix_rep = pd.read_csv(
            "other_datasets/celer/data_v2.0/sent_fix.tsv",
            sep="\t",
        )
        metadata = pd.read_csv(
            "other_datasets/celer/data_v2.0/metadata.tsv",
            sep="\t",
        )[["List", "L1"]]
